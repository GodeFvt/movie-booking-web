...
<template>
  <div
    class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-800"
  >
    <div
      class="mt-7 w-96 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700"
    >
            ...
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  />
                  <div
                    class="absolute inset-y-3 end-0 pointer-events-none pe-3"
                    v-if="errorMsg"
                  >
                    <svg
                      class="size-5 text-red-500"
